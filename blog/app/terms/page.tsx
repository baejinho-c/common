    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">AutoBlogger 서비스 이용약관을 확인하세요.</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle className="text-xl text-center">AutoBlogger 서비스 이용약관</CardTitle>
          </CardHeader>
          <CardContent className="prose prose-gray max-w-none">
            <div className="space-y-6 text-sm leading-relaxed">
              <section>
                ...
                <p>
                  이 약관은 (주)리스티아트(이하 "회사")가 제공하는 AutoBlogger 서비스(이하 "서비스")의 이용과 관련하여
              ...
              <section>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  <li>"서비스"란 회사가 제공하는 AI 기반 블로그 자동화 플랫폼을 의미합니다.</li>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  <li>
                    ...
                    <ul className="list-disc pl-6 mt-2 space-y-1">
                      <li>AI 기반 블로그 콘텐츠 생성 서비스</li>
                      <li>네이버 블로그 자동 포스팅 서비스</li>
                      <li>SEO 최적화 및 분석 서비스</li>
                      <li>기타 회사가 정하는 업무</li>
                    </ul>
                  </li>
              ...
              <section>
                <h2 className="text-lg font-bold text-gray-900 mb-3">제7조 (회원탈퇴 및 자격 상실 등)</h2>
                <ol className="list-decimal pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-lg font-bold text-gray-900 mb-3">제8조 (회원에 대한 통지)</h2>
                <ol className="list-decimal pl-6 space-y-2">
                  <li>
                    회사가 회원에 대한 통지를 하는 경우, 회원이 회사와 미리 약정하여 지정한 전자우편 주소로 할 수
                    있습니다.
                  </li>
                  <li>
                    회사는 불특정다수 회원에 대한 통지의 경우 1주일이상 서비스 게시판에 게시함으로서 개별 통지에 갈음할
                    수 있습니다.
                  </li>
                </ol>
              </section>
              ...
              <section>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <li>
                    회사는 수집된 개인정보를 목적외의 용도로 이용할 수 없으며, 새로운 이용목적이 발생한 경우 또는
              ...
              <section>
                <h2 className="text-lg font-bold text-gray-900 mb-3">제10조 (회사의 의무)</h2>
                <ol className="list-decimal pl-6 space-y-2">
                  <li>
                  ...
                  <li>
                    회사는 서비스이용과 관련하여 이용자로부터 제기된 의견이나 불만이 정당하다고 객관적으로 인정될
                    경우에는 적절한 절차를 거쳐 즉시 처리하여야 합니다.
                  </li>
                </ol>
              </section>

              <section>
                <h2 className="text-lg font-bold text-gray-900 mb-3">제11조 (회원의 의무)</h2>
              ...
              <section>
                <h2 className="text-lg font-bold text-gray-900 mb-3">제12조 (저작권의 귀속 및 이용제한)</h2>
                <ol className="list-decimal pl-6 space-y-2">
              ...
              <section>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <li>
                    회사는 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다. 다만, 신속한 처리가
