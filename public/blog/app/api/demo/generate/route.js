...
- 적절한 길이 (800-1200자 정도)
- 단락을 적절히 나누어 가독성 향상
- 마무리는 독자의 행동을 유도하는 내용으로`,o=await e.chat.completions.create({model:c.o,messages:[{role:"system",content:r},{role:"user",content:`다음 주제에 대한 블로그 포스트를 작성해주세요: "${t}"`}],max_tokens:1500,temperature:.7}),n=o.choices[0]?.message?.content||"";return console.log(`[Demo API] AI 생성 완료, 길이: ${n.length}`),i.NextResponse.json({success:!0,content:n,isDemo:!1})}{console.log(`[Demo API] 데모 콘텐츠 제공`);let e=p(t);return await new Promise(e=>setTimeout(e,2e3)),i.NextResponse.json({success:!0,content:e,isDemo:!0})}}catch(r){console.error("[Demo API] 생성 오류:",r);let{topic:t}=await e.json(),s=p(t||"블로그 작성");return i.NextResponse.json({success:!0,content:s,isDemo:!0})}}function p(e){let t={건강:`# ${e}에 대한 완벽 가이드
...
더 자세한 정보가 필요하시다면 전문가의 도움을 받는 것도 좋은 방법입니다. 성공적인 ${e} 여정을 응원합니다! ✨`};return e.includes("건강")||e.includes("다이어트")||e.includes("운동")||e.includes("홈트")?t["건강"]:e.includes("재테크")||e.includes("투자")||e.includes("돈")||e.includes("부동산")?t["재테크"]:t.default}let d=new o.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/demo/generate/route",pathname:"/api/demo/generate",filename:"route",bundlePath:"app/api/demo/generate/route"},resolvedPagePath:"/Users/baejinho/Documents/resty/blog/app/api/demo/generate/route.ts",nextConfigOutput:"",userland:r}),{workAsyncStorage:m,workUnitAsyncStorage:$,serverHooks:g}=d;function x(){return(0,a.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:$})}},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},78335:()=>{},96487:()=>{}};var t=require("../../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),r=t.X(0,[4447,580,7932],()=>s(53037));module.exports=r})();