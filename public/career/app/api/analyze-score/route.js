"use strict";(()=>{var e={};e.id=3297,e.ids=[3297],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},67568:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>A,patchFetch:()=>f,requestAsyncStorage:()=>m,routeModule:()=>l,serverHooks:()=>S,staticGenerationAsyncStorage:()=>h});var a={};n.r(a),n.d(a,{POST:()=>d});var r=n(73278),o=n(45002),s=n(54877),i=n(71309),c=n(44742),u=n(97758),p=n(43858);async function d(e){try{let{scores:t,grade:n,interests:a,goals:r}=await e.json();if(!t||!n)return i.NextResponse.json({error:"성적과 학년 정보가 필요합니다."},{status:400});if(!await (0,u.dp)(u.xf.SCORE_ANALYSIS))return i.NextResponse.json({error:`크레딧이 부족합니다. 성적 분석에는 ${u.xf.SCORE_ANALYSIS} 크레딧이 필요합니다.`},{status:402});await (0,u.Zg)("deduct",u.xf.SCORE_ANALYSIS,"성적 분석 및 진학 상담");let o=(await (0,p.sM)({korean:t.korean,english:t.english,math:t.math,science:t.science,social:t.social,grade:n})).slice(0,5),s=o.map(e=>`- ${e.school.school_name_ko} (${e.school.sido_name}, ${e.school.hs_category_name||"일반고"})
