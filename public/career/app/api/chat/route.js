"use strict";(()=>{var e={};e.id=744,e.ids=[744],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8048:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>f,patchFetch:()=>g,requestAsyncStorage:()=>m,routeModule:()=>l,serverHooks:()=>h,staticGenerationAsyncStorage:()=>A});var r={};n.r(r),n.d(r,{POST:()=>d});var a=n(3278),o=n(5002),s=n(4877),i=n(1309),u=n(4742),p=n(6123),c=n(3858);async function d(e){try{let{messages:t,schoolId:n}=await e.json();if(!t||!Array.isArray(t))return i.NextResponse.json({error:"메시지가 필요합니다."},{status:400});let r=0;if(t.length>1){let e=n?p.xf.SCHOOL_CONSULTATION:p.xf.CHAT;if(!await (0,p.dp)(e))return i.NextResponse.json({error:`크레딧이 부족합니다. ${n?"학교 상담":"일반 채팅"}에는 ${e} 크레딧이 필요합니다.`},{status:402});r=e;let t=n?`AI 진로 상담 (학교 연계)`:"AI 진로 상담";await (0,p.Zg)("deduct",e,t)}let a="";if(n){let e=await (0,c.SV)(n);e&&(a=`
