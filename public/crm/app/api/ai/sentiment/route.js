...
[이름]
[직책]
[연락처]`}return i("ai_email","generate"),r}async predictChurnRisk(e){let t;await new Promise(e=>setTimeout(e,1800));let a=0,n=[];if(e.lastContact){let t=Math.floor((Date.now()-new Date(e.lastContact).getTime())/864e5);t>90?(a+=40,n.push("90일 이상 미접촉")):t>60?(a+=25,n.push("60일 이상 미접촉")):t>30&&(a+=15,n.push("30일 이상 미접촉"))}0===(e.deals?.filter(e=>!["closed-won","closed-lost"].includes(e.stage))||[]).length&&(a+=30,n.push("진행 중인 거래 없음")),"inactive"===e.status&&(a+=35,n.push("비활성 상태")),0===(e.activities?.filter(e=>new Date(e.date)>new Date(Date.now()-30*24*60*60*1e3))||[]).length&&(a+=20,n.push("최근 활동 없음"));let s=Math.min(100,a)/100,r=["high"==(t=s>=.7?"high":s>=.4?"medium":"low")?"즉시 고객과 연락하여 현재 상황을 파악하세요":"정기적인 소통을 통해 관계를 유지하세요","고객의 비즈니스 변화와 새로운 니즈를 파악하세요","가치 있는 콘텐츠와 인사이트를 정기적으로 공유하세요","고객 만족도 조사를 실시하여 개선점을 찾으세요"];return i("ai_churn","predict"),{riskLevel:t,probability:s,factors:n,recommendations:r}}}let s=n.getInstance()}};var t=require("../../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),i=t.X(0,[379,833],()=>a(5801));module.exports=i})();