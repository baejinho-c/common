...
- 해결책 중심적 접근
- 인지행동치료 기법 활용
- 마음챙김과 자기돌봄 강조`,c={async generateResponse(e,t,s=[]){try{var c;let l=t;l||(l=i(),n.set(l,{id:l,messages:[],startTime:new Date,lastActivity:new Date}));let p=n.get(l);p&&(p.lastActivity=new Date);let g=function(e){for(let[t,s]of Object.entries(a))if(s.some(t=>e.includes(t)))return t;return"neutral"}(e);let d=o.some(t=>e.includes(t)),m=r.getGenerativeModel({model:"gemini-1.5-flash",systemInstruction:u}),y=s.slice(-10).map(e=>`${"user"===e.role?"사용자":"상담사"}: ${e.content}`).join("\n"),h=`
대화 맥락:
${y}
...
당신의 생명은 소중합니다. 지금 이 순간의 고통이 영원하지 않다는 것을 기억해주세요. 전문가들이 당신을 도울 준비가 되어 있습니다.`}},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},23400:(e,t,s)=>{"use strict";s.r(t),s.d(t,{patchFetch:()=>h,routeModule:()=>g,serverHooks:()=>y,workAsyncStorage:()=>d,workUnitAsyncStorage:()=>m});var r={};s.r(r),s.d(r,{GET:()=>p,POST:()=>l});var n=s(96559),o=s(48088),a=s(37719),i=s(32190),u=s(5830),c=s(95614);async function l(e){try{let{emotions:t,diaryEntry:s,userId:r}=await e.json();if(!t&&!s)return i.NextResponse.json({error:"감정 데이터 또는 일기 내용이 필요합니다."},{status:400});let n="다음 감정 데이터를 분석하고 인사이트를 제공해주세요:\n\n";t&&(n+=`감정 점수: ${JSON.stringify(t)}
`),s&&(n+=`일기 내용: ${s}
`),n+=`
...
5. 추천 활동
6. 긍정적 변화를 위한 제안
    `;let o=await (0,u.generateAIResponse)(n,u.PSYCHOLOGY_PROMPTS.emotionCoach,{maxTokens:1200,temperature:.6}),a=t?Object.values(t).reduce((e,t)=>e+("number"==typeof t?t:0),0)/Object.keys(t).length:5;return c.sK.emotionDiaryWrite(a.toString()),c.sK.featureUsage("emotion_analysis"),console.log(`💭 감정 분석 완료:`,{emotionScore:a,provider:o.provider,tokens:o.tokens,cost:o.cost}),i.NextResponse.json({insights:o.content,emotionScore:a,provider:o.provider,tokens:o.tokens,cost:o.cost,timestamp:new Date().toISOString()})}catch(e){return console.error("감정 분석 API 오류:",e),c.sK.errorTracking("emotion_analysis_error","api"),i.NextResponse.json({error:"감정 분석 중 문제가 발생했습니다. 잠시 후 다시 시도해주세요.",details:e instanceof Error?e.message:"Unknown error"},{status:500})}}async function p(){return i.NextResponse.json({status:"감정 분석 서비스가 정상 작동 중입니다.",timestamp:new Date().toISOString()})}let g=new n.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/emotion-insights/route",pathname:"/api/emotion-insights",filename:"route",bundlePath:"app/api/emotion-insights/route"},resolvedPagePath:"/Users/baejinho/Documents/resty/mind/app/api/emotion-insights/route.ts",nextConfigOutput:"",userland:r}),{workAsyncStorage:d,workUnitAsyncStorage:m,serverHooks:y}=g;function h(){return(0,a.patchFetch)({workAsyncStorage:d,workUnitAsyncStorage:m})}},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},78335:()=>{},95614:(e,t,s)=>{"use strict";s.d(t,{sK:()=>r});let r={trackPageView:(e,t)=>{},startChat:e=>{},viewRegionalPage:e=>{},sendMessage:(e,t)=>{},endChat:e=>{},detectCrisis:(e,t)=>{},error:(e,t,s)=>{},performance:(e,t,s)=>{},trackUserAction:(e,t,s,r)=>{},buttonClick:e=>{},trackConversion:(e,t)=>{},trackContentInteraction:(e,t,s)=>{}}},96487:()=>{}};var t=require("../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),r=t.X(0,[447,580,449],()=>s(23400));module.exports=r})();