"use strict";(()=>{var e={};e.id=915,e.ids=[915],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2048:e=>{e.exports=require("fs")},9801:e=>{e.exports=require("os")},5315:e=>{e.exports=require("path")},3015:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>w,patchFetch:()=>b,requestAsyncStorage:()=>h,routeModule:()=>l,serverHooks:()=>x,staticGenerationAsyncStorage:()=>m});var s={};r.r(s),r.d(s,{POST:()=>c});var i=r(3278),o=r(5002),n=r(4877),a=r(1173),p=r(6914),u=r(3389);let d=u.Ry({expandedContent:u.Z_().describe("웹사이트 정보를 반영한 확장된 노드 내용"),additionalTags:u.IX(u.Z_()).describe("웹사이트에서 추출한 추가 태그들"),insights:u.IX(u.Z_()).describe("웹사이트에서 얻은 주요 인사이트들"),relatedTopics:u.IX(u.Z_()).describe("웹사이트에서 발견한 관련 주제들")});async function c(e){try{if(!process.env.OPENAI_API_KEY)return Response.json({error:"OpenAI API 키가 설정되지 않았습니다."},{status:500});let{nodeId:t,title:r,content:s,tags:i,websites:o}=await e.json();console.log("\uD83C\uDF10 웹사이트 기반 노드 확장 시작:",r);let n=o.map((e,t)=>`${t+1}. ${e.title||e.url}
   URL: ${e.url}
   설명: ${e.description||"설명 없음"}`).join("\n\n"),{object:u}=await (0,a.jA)({model:(0,p.fr)("gpt-4o-mini"),schema:d,prompt:`
