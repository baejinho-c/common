"use strict";(()=>{var e={};e.id=790,e.ids=[790],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2048:e=>{e.exports=require("fs")},9801:e=>{e.exports=require("os")},5315:e=>{e.exports=require("path")},7650:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>f,patchFetch:()=>h,requestAsyncStorage:()=>m,routeModule:()=>u,serverHooks:()=>g,staticGenerationAsyncStorage:()=>y});var n={};o.r(n),o.d(n,{POST:()=>d});var r=o(3278),a=o(5002),i=o(4877),s=o(1309),l=o(1173),c=o(1584),p=o(2987);async function d(e){try{let{description:t,businessType:o,targetAudience:n,style:r,features:a,colors:i,fonts:d}=await e.json(),u=process.env.OPEN_API_KEY||process.env.OPENAI_API_KEY;if(!u)return s.NextResponse.json({error:"OpenAI API key not configured"},{status:500});let m=(0,p.ob)({description:t,businessType:o,targetAudience:n,style:r,features:a,colors:i,fonts:d}),{text:y}=await (0,l._4)({model:(0,c.fr)("gpt-4o",{apiKey:u}),prompt:m,temperature:.65,maxTokens:4e3});return s.NextResponse.json({plan:y})}catch(e){return console.error("Plan generation error:",e),s.NextResponse.json({error:"Failed to generate plan"},{status:500})}}let u=new r.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/generate-plan/route",pathname:"/api/generate-plan",filename:"route",bundlePath:"app/api/generate-plan/route"},resolvedPagePath:"/Users/baejinho/Documents/resty/mypage/app/api/generate-plan/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:m,staticGenerationAsyncStorage:y,serverHooks:g}=u,f="/api/generate-plan/route";function h(){return(0,i.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:y})}},2987:(e,t,o)=>{o.d(t,{Mz:()=>d,Yf:()=>n,ZF:()=>u,ob:()=>c,oy:()=>p});let n=`You are an elite product designer and front-end engineer who builds premium one-page brand websites.
