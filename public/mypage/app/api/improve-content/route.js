...
`,{text:p}=await (0,i._4)({model:(0,u.fr)("gpt-4o",{apiKey:n}),prompt:s,temperature:.6,maxTokens:1500});return a.NextResponse.json({improvedContent:p})}catch(e){return console.error("Content improvement error:",e),a.NextResponse.json({error:"Failed to improve content"},{status:500})}}let m=new n.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/improve-content/route",pathname:"/api/improve-content",filename:"route",bundlePath:"app/api/improve-content/route"},resolvedPagePath:"/Users/baejinho/Documents/resty/mypage/app/api/improve-content/route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:d,staticGenerationAsyncStorage:v,serverHooks:l}=m,x="/api/improve-content/route";function P(){return(0,p.patchFetch)({serverHooks:l,staticGenerationAsyncStorage:v})}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),o=t.X(0,[787,698],()=>r(8350));module.exports=o})();