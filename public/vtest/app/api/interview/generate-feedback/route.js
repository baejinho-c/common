(()=>{var e={};e.id=461,e.ids=[461],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},21820:e=>{"use strict";e.exports=require("os")},29021:e=>{"use strict";e.exports=require("fs")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},33873:e=>{"use strict";e.exports=require("path")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},78335:()=>{},84368:(e,r,t)=>{"use strict";t.r(r),t.d(r,{patchFetch:()=>g,routeModule:()=>d,serverHooks:()=>x,workAsyncStorage:()=>l,workUnitAsyncStorage:()=>m});var s={};t.r(s),t.d(s,{POST:()=>u});var a=t(96559),o=t(48088),n=t(37719),i=t(32190),p=t(9239);let c=(0,t(81248).ry)({apiKey:process.env.OPEN_AI_KEY});async function u(e){try{let{messages:r,config:t,duration:s,questionsAnswered:a}=await e.json(),o=r.filter(e=>"user"===e.type).map(e=>e.analysis?.score||3),n=o.reduce((e,r)=>e+r,0)/o.length,u=r.map(e=>`${"interviewer"===e.type?"면접관":"지원자"}: ${e.content}`).join("\n"),d=`다음은 ${t.jobCategory} 직군 ${t.difficulty} 수준의 모의면접 결과입니다.
